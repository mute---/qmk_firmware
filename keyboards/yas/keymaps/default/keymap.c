...
#define SWAP MAGIC_TOGGLE_SWAP_CTL_GUI
...
[ADJUST] = KEYMAP( \
  ...
  _______, _______, _______, _______, _______, NKRO,                      NKRO,    _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, SWAP,                      SWAP,    _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
           _______, _______, _______, _______, _______, _______, _______, _______, KC_RCTL, KC_RALT, KC_RGUI, MO(EXT)           \
),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  bool is_mac = keymap_config.swap_ctl_gui;
